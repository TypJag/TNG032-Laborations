...
% uppdaterad av Lukas Maly, mars 2021 ITN
...
%       set(gcf,'tag','transformserv','un','pix','pos',size+[10 10 -50 -50],'numbertitle','off',...    % LM-update
        set(gcf,'tag','transformserv','un','pix','pos', [(size(3)+size(1))/2 - 460, (size(4)+size(2))/2 - 310, 920, 620],'numbertitle','off',...
        ...
        axes('un','pix','pos',[200 400 500 200],'ytick',[0:0.2:2],'ylim',[0 2],'fontn','times','fontsize',11,...
            'color',[1 1 0.8],'tag','ploty','SortMethod','childorder','ylimmode','manual','xlimmode','manual','xgr','on','ygrid','on');        
%           'color',[1 1 0.8],'tag','ploty','DrawMode',  'fast',      'ylimmode','manual','xlimmode','manual','xgr','on','ygrid','on');     % LM-update       
